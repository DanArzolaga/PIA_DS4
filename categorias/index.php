...
$sqlCategoria   = ("SELECT * FROM categoria ORDER BY IdCategoria");
...
<div class="col-sm-12">
  <div class="row">
    <div class="col mb-3">
      <a class="btn btn-primary" href="../menu/index.php"><i class="bi bi-arrow-left-circle"></i> Regresar</a>
    </div>
  </div>
</div>
...
<div class="row text-center">
  ...
  <div class="col-md-6"> 
    <strong>Lista de Categorias <span>  ( <?php echo $cantidad; ?> )</span> </strong>
  </div>
</div>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  <div class="body">
      <div class="row clearfix">
        ...
        <?php include('registrarCategoria.php');  ?>
        </div>  
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover" id="datatable">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?php echo $dataCategoria['Descrip']; ?></td>
                            
                          <td> 
                            
                              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editChildresn<?php echo $dataCategoria['IdCategoria']; ?>">
                                 <i class="bi bi-pencil-square"></i>
                              </button>

                              <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteChildresn<?php echo $dataCategoria['IdCategoria']; ?>">
